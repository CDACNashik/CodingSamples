class SubclassTest1 {
	...
	private static double tax(payroll.Employee emp) {
		double i = emp.income(); //calling income method of payroll.Employee class on object referred by emp (emp.class.income())
		return i > 10000 ? 0.15 * (i - 10000) : 0;
	}

	public static void main(String[] args) {
		var jack = new payroll.Employee(); //var will be inferred from initializer
		jack.setHours(186);
		jack.setRate(52);
